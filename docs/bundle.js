...
var mobileMenu = exports.mobileMenu = function () {
    function mobileMenu() {
        ...
        this.openClick[0].addEventListener('click', function () {
            return _this.onClickMenu();
        });
        this.closeClick[0].addEventListener('click', function () {
            return _this.onCloseMenu();
        });
        this.getStart[0].addEventListener('click', function () {
            return _this.moveMenu();
        });
    }
